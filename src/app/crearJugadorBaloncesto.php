...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nombre && $fecha && $dni) {
        ...
        // Redirigir al listado de jugadores del equipo
...
<div class="container mt-5">
    <h1 class="text-center text-primary">Añadir Jugador al Equipo de Baloncesto</h1>
    ...
    <form method="post" class="mt-4">
        ...
        <div class="text-center">
            ...
            <a href="jugadoresEquipoBaloncesto.php?idEquipo=<?= urlencode($idEquipo) ?>" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
