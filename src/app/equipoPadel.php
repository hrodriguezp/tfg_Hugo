...
$query = $conn->prepare("SELECT idEquipo, categoria, deporte FROM equipos WHERE LOWER(deporte) = 'padel'");
$query->execute();
$resultado = $query->get_result();

include 'header.php'; // Contiene <!DOCTYPE html>, <html>, <head>, <body>
?>
<?php if (isset($_SESSION['nombreUsuario']) && $_SESSION['nombreUsuario'] === 'admin'): ?>
    <div class="container mt-4 text-right">
        <a href="crearEquipos.php" class="btn btn-success">
            Crear equipo de Padel
        </a>
    </div>
<?php endif; ?>
<div class="container py-5">
    <h1 class="mb-4 text-success">Equipos de Pádel</h1>
...
<script>
    function verJugadores(idEquipo) {
        window.location.href = 'jugadoresEquipoPadel.php?idEquipo=' + idEquipo;
    }
</script>

<?php include 'footer.php'; // Cierra </body> y </html> ?>
