...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validar si se seleccionó un equipo
    if (empty($idEquipo)) {
        $mensaje = "Por favor, selecciona un equipo antes de confirmar la reserva.";
        $tipoMensaje = "danger";
    } else {
        // Verificar si la pista ya está reservada para ese día y hora
        $stmt = $conn->prepare("
            SELECT h.idHorario
            FROM horarios h
...
// Obtener los equipos (reemplaza el filtro según el deporte correspondiente)
